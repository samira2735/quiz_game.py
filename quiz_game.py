question_data = [
    ...
    {"text": "The Spitfire originated from a racing plane.", "answer": "True"},
    {
        "text": "In World War II, Great Britain used inflatable tanks on the ports of Great Britain to divert Hitler away from Normandy/D-day landing.",
        "answer": "True"
    },
    {"text": "The Tiananmen Square protests of 1989 were held in Hong Kong.", "answer": "False"},
    {"text": "Thomas Crapper was a plumber who invented the flushing toilet.", "answer": "False"},
    {
    ...
    {
        "text": "The Enlightenment was an era of philosophies, advancements, and scientific theories to improve society.",
        "answer": "True"
    },
